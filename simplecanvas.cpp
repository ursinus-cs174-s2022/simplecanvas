...
void SimpleCanvas::drawLineLow(int x0, int y0, int x1, int y1, uint8_t R, uint8_t G, uint8_t B) {
    int dx = x1 - x0;
    int dy = y1 - y0;
    int yi = 1;
    if (dy < 0) {
...
// Helper method for Bresenham's line algorithm
void SimpleCanvas::drawLineHigh(int x0, int y0, int x1, int y1, uint8_t R, uint8_t G, uint8_t B) {
    int dx = x1 - x0;
    int dy = y1 - y0;
    int xi = 1;
    if (dx < 0) {
 ...
 * 
 */
void SimpleCanvas::createWrapper() {
 ...
 */
SimpleCanvas::SimpleCanvas(int32_t width, int32_t height) {
    this->width = width;
    this->height = height;
 ...
 */
void SimpleCanvas::setPixel(int x, int y, uint8_t R, uint8_t G, uint8_t B) {
 ...
 * @param B Blue channel
 */
void SimpleCanvas::fillRect(int x0, int y0, int w, int h, uint8_t R, uint8_t G, uint8_t B) {
 ...
 * @param B Blue channel
 */
void SimpleCanvas::clearRect(uint8_t R, uint8_t G, uint8_t B) {
 ...
 */
void SimpleCanvas::drawRect(int x0, int y0, int w, int h,
 ...
 * @param B Blue channel
 */
void SimpleCanvas::drawLine(int x0, int y0, int x1, int y1, uint8_t R, uint8_t G, uint8_t B) {
 ...
 * @param B Blue channel
 */
void SimpleCanvas::drawLine(int x0, int y0, int x1, int y1, int thickness, uint8_t R, uint8_t G, uint8_t B) {
    if (thickness == 1) {
 ...
 * @param B Blue channel
 */
void SimpleCanvas::fillCircle(int cx, int cy, double r, uint8_t R, uint8_t G, uint8_t B) {
